...
import type { ValidationAttributes, VuetifyRuleAliases } from "../../src/util/validation";
import {
...
describe("mapOpenAPIToVuetifyValidationRules", () => {
    ...
    it("adds the required rule", () => {
        ...
        const result = mapOpenAPIToVuetifyValidationRules(rules, attributes, "name");
    ...
    it("maps equal minLength and maxLength to strictLength", () => {
        ...
        const result = mapOpenAPIToVuetifyValidationRules(rules, attributes, "value");
...
describe("getOpenAPIValidationConstraint", () => {
    ...
    it("returns the requested constraint", () => {
        ...
        expect(
            getOpenAPIValidationConstraint(attributes, "name", "required")
        ).toBe(true);
    });
